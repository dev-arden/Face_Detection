...
// realpleaseDoc.cpp : CrealpleaseDoc 클래스의 구현
//
...
IMPLEMENT_DYNCREATE(CrealpleaseDoc, CDocument)

BEGIN_MESSAGE_MAP(CrealpleaseDoc, CDocument)
END_MESSAGE_MAP()


// CrealpleaseDoc 생성/소멸

CrealpleaseDoc::CrealpleaseDoc()
{
...
BOOL CrealpleaseDoc::OnNewDocument()
{
...
// CrealpleaseDoc serialization

void CrealpleaseDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
// 축소판 그림을 지원합니다.
void CrealpleaseDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CrealpleaseDoc::InitializeSearchContent()
{
...
void CrealpleaseDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
#ifdef _DEBUG
void CrealpleaseDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CrealpleaseDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
BOOL CrealpleaseDoc::OnOpenDocument(LPCTSTR lpszPathName)
{
...
void CrealpleaseDoc::CopyClipboard(BYTE* m_CpyImg, int height, int width, int biBitCount)
{
...
void CrealpleaseDoc::OnSKindetection()
{
